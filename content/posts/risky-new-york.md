...
<iframe src="/maps/nyc-1970.html" width="100%" height="600px" style="border:none; border-radius:6px;"></iframe>
...
<iframe src="/maps/nyc-1990.html" width="100%" height="600px" style="border:none; border-radius:6px;"></iframe>

* * *

Note: In line with reproducible research practices, all of the data and code used for this post is available on [GitHub](https://github.com/lukeave/Risky-New-York).
