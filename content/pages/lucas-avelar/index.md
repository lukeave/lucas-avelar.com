...
I am a Digital History PhD Candidate and Graduate Instructor of Record at Clemson University. I have the privilege to be part of the inaugural cohort of the [Digital History PhD Program at Clemson](https://www.clemson.edu/cah/academics/history-and-geography/graduate/digital-history-phd/), the first of its kind in the nation and uniquely positioned to merge rigorous historical research with cutting-edge computational methods for analyzing large sets of historical data.<br>


In 2023, I was selected to attend the inaugural NEH-funded Archives as Data Institute at Columbia University. I also served as one of the 2024 Andrew W. Mellon Data Fellows for the project [Freedom on the Move](http://freedomonthemove.org) at Cornell University.
...
I hold an [MA in Public History and Historic Preservation](https://history.colostate.edu/graduate/) from Colorado State University and a [BA in History](https://historia.ufrj.br/) from the Federal University of Rio de Janeiro. Still in Brazil, I worked with the Department of Culture at the Rio de Janeiro State Legislature (ALERJ).

In Colorado, I worked an internship as an Archives Technician with the U.S. Department of Agriculture's National Wildlife Research Center, in collaboration with the [Public & Environmental History Center](https://pehc.colostate.edu/). In that role, I assisted with digital preservation, data and metadata management, and long-term archival storage of documents of historic and institutional importance. You can learn more about my experience in that role by reading [the short piece featured on the PEHC's Newsletter of Fall 2021 (Volume 7, page 14).](https://pehc.colostate.edu/wp-content/uploads/sites/57/2021/11/PLHC-Newsletter-2021-FINAL-compressed.pdf)

I also worked as a Geographic Information Systems intern with the [Geospatial Centroid](https://gis.colostate.edu/) in partnership with the [Larimer County Department of Natural Resources](https://www.larimer.gov/naturalresources) on a short-term research and mapping project related to the County's Small Grants for Community Partnering Program.

{{< figure src="/wp-content/uploads/2025/02/IMG%5F7169-scaled.jpeg" alt="" caption="" >}}
